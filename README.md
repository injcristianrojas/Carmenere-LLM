...
* Local LLM server for IDE use (Zed, specifically)

This works in a Linux laptop, using Intel Iris Xe Graphics (RPL-U)

# Setup

This project uses UV. Install the dependencies:
...
I reccommend downloading INT4-compressed models. Download
...
http://127.0.0.1:8000/v1. Set whatever API key you want. The model is `local_openvino`.
